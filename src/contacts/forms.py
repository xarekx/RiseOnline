...
class ContactForm(forms.ModelForm):
    ...
    msg_description = forms.CharField(max_length=500, help_text='Type what you want to tell me', label="Description",widget=forms.Textarea(attrs={'class': 'flex text-2xs md:text-xs w-full'}))
